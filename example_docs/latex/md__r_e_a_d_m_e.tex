...
The project also contains {\ttfamily libuspp}, or Ultra Simple Package Processor, which contains the functions necessary to enable all the functionality of {\ttfamily uspm}\doxysection{How it works}\label{md__r_e_a_d_m_e_autotoc_md39}
...
The tarballs usually will contain the files necessary to install already compiled code.\doxysection{Building and Installing}\label{md__r_e_a_d_m_e_autotoc_md40}
...
\DoxyCodeLine{make install}
\end{DoxyCode}
\doxysection{How to create a package for U\+S\+PM}\label{md__r_e_a_d_m_e_autotoc_md41}
\doxysubsection{The easy way}\label{md__r_e_a_d_m_e_autotoc_md42}
...
\end{DoxyCode}
\doxysubsection{The hard way}\label{md__r_e_a_d_m_e_autotoc_md43}
1) Compile the package from source
